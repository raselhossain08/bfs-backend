...
export class User {
    ...
    @OneToMany(() => RecurringDonation, recurringDonation => recurringDonation.user, { cascade: true })
    recurringDonations: RecurringDonation[];

    @OneToMany(() => Goal, goal => goal.user, { cascade: true })
    goals: Goal[];

    @OneToMany(() => SavedCampaign, savedCampaign => savedCampaign.user, { cascade: true })
    savedCampaigns: SavedCampaign[];

    @OneToMany(() => Referral, referral => referral.referrer, { cascade: true })
    referralsSent: Referral[];

    @OneToMany(() => Referral, referral => referral.referredUser, { cascade: true })
