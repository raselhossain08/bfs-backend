...
async function createDefaultCategories() {
    ...
    const defaultCategories = [
        { name: 'Organization News', slug: 'organization-news', description: 'Updates and news from BirdsFly Sangstha', color: '#0d9488', order: 1 },
        { name: 'Community Support', slug: 'community-support', description: 'Stories about community development and support', color: '#6366f1', order: 2 },
        { name: 'Healthcare', slug: 'healthcare', description: 'Health and medical initiatives', color: '#ef4444', order: 3 },
        { name: 'Education', slug: 'education', description: 'Educational programs and literacy', color: '#f59e0b', order: 4 },
        { name: 'Environment', slug: 'environment', description: 'Environmental conservation and sustainability', color: '#22c55e', order: 5 },
        { name: 'Empowerment', slug: 'empowerment', description: 'Women and youth empowerment stories', color: '#ec4899', order: 6 },
        { name: 'Impact Stories', slug: 'impact-stories', description: 'Real stories of transformation and hope', color: '#8b5cf6', order: 7 },
    ];
    ...
    for (const category of defaultCategories) {
        await dataSource.query(
            ...
            [category.name, category.slug, category.description, category.color, category.color, category.order, 'active']
        );
...
async function migrateArticles(): Promise<number> {
    ...
    for (const oldArticle of oldArticles) {
        ...
        const categoryName = typeof oldArticle.category === 'string'
            ? oldArticle.category
        ...
        const authorName = typeof oldArticle.author === 'string'
            ? oldArticle.author
            : oldArticle.author?.name || null;

        const authorImage = typeof oldArticle.author === 'object'
            ? oldArticle.author?.image || oldArticle.authorImage || null
            : oldArticle.authorImage || null;

        const authorBioVal = typeof oldArticle.author === 'object'
            ? oldArticle.author?.bio || oldArticle.authorBio || null
            : oldArticle.authorBio || null;

        const status = oldArticle.status || 'published';
        const publishedAt = status === 'published' ? (oldArticle.date || new Date().toISOString()) : null;
        ...
        try {
            await dataSource.query(
                ...
                [
                    ...
                    oldArticle.contentBlocks ? JSON.stringify(oldArticle.contentBlocks) : null,
                    oldArticle.videoUrl || null,
                    oldArticle.images ? (typeof oldArticle.images === 'string' ? oldArticle.images : JSON.stringify(oldArticle.images)) : null,
                    publishedAt,
                ]
            );
    ...
    const defaultArticles = [
        {
            ...
            authorBio: "Field Coordinator with 8 years of experience in disaster response across coastal Bangladesh.",
            categoryName: "Community Support",
            categoryId: getCategoryId("Community Support"),
            tags: JSON.stringify(["community", "resilience", "disaster-response", "empowerment"]),
            status: "published",
            featured: true,
            views: 234,
            likes: 45,
        ...
        },
        {
            ...
            description: "Deploying high-precision filtration nodes to ensure safe water access in rural sectors.",
            ...
            authorBio: "Healthcare Lead specializing in WASH programs and community health initiatives.",
        ...
        },
        {
            ...
            description: "Upgrading rural education nodes with tactical digital toolkits and remote learning.",
            ...
            authorBio: "Digital Trainer and Education Program Coordinator with a passion for bridging the digital divide.",
            categoryName: "Education",
            categoryId: getCategoryId("Education"),
            tags: JSON.stringify(["education", "digital-literacy", "youth", "empowerment"]),
            status: "published",
            featured: false,
            views: 156,
            likes: 32,
        ...
        },
        {
            ...
            authorBio: "Program Lead for Women Empowerment initiatives across Satkhira District.",
            categoryName: "Empowerment",
            categoryId: getCategoryId("Empowerment"),
            tags: JSON.stringify(["women", "empowerment", "vocational-training", "livelihoods"]),
            status: "published",
            featured: false,
            views: 142,
            likes: 28,
        ...
        },
        {
            ...
            authorBio: "Environmental scientist leading mangrove conservation research in coastal Bangladesh.",
            categoryName: "Environment",
            categoryId: getCategoryId("Environment"),
            tags: JSON.stringify(["environment", "sundarbans", "mangrove", "conservation"]),
            status: "published",
            featured: false,
            views: 198,
            likes: 41,
        ...
        },
        {
            ...
            tags: JSON.stringify(["launch", "satkhira", "coastal-communities", "ngo", "bangladesh"]),
            status: "published",
            featured: true,
            views: 500,
            likes: 67,
